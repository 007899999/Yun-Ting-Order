define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/Monthly/index' + location.search,
                    add_url: 'finance/Monthly/add',
                    // edit_url: 'Book/edit',
                    // del_url: 'Book/del',
                    multi_url: 'finance/Monthly/multi',
                    table: 'Monthly',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    url: function (value, row, index) {
                                        return "finance/overview/detail?timestamp="+value.timestamps+"&type=3";
                                    },
                                }
                            ],}
                    ]
