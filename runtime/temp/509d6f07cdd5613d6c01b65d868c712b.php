<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"E:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\order\settle.html";i:1562811158;s:80:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1562751673;s:77:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:79:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">应支付金额:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-sum_money" class="form-control" name="row[sum_money]" type="text" value="<?php echo htmlentities($row['sum_money']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">姓名:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-member_id" data-rule="required" data-source="Member/getAll" data-params='{"custom[type]":"member"}' class="form-control selectpage" name="row[member_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
