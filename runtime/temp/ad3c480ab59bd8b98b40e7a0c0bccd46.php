<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"E:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\index\login.html";i:1562638935;s:77:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:79:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="login-wrapper">
                <div class="login-screen">
                        ...
                        <div class="login-form">
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="form-group" >
                                    <label class="inline" for="keeplogin" style="display: none">
                    ...
                    <p class="copyright"><a href="https://www.fastadmin.net">Powered By 芸廷小坐</a></p>
                </div>
            </div>
        </div>
