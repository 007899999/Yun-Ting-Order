<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"E:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\cate\add.html";i:1563159815;s:80:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1562751673;s:77:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:79:"E:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-source="cate/selectpage" data-params='{"custom[type]":"goods_category"}' class="form-control selectpage" name="row[category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Eng_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-eng_name" class="form-control" name="row[eng_name]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">未选中图片(1:1):</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">选中图片(1:1):</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-s_image" class="form-control" size="50" name="row[s_image]" type="text">
                <div class="input-group-addon no-border no-padding">
