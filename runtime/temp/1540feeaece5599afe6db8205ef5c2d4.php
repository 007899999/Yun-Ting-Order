<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"E:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/common\view\tpl\dispatch_jump.tpl";i:1557482263;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/fastadmin/public/" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
